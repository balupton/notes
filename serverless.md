...
- [Good overview of Microsoft's Serverless Functions offering called Azure Functions.]( https://www.youtube.com/watch?v=Qb0r_gyJZYk&list=PLW72fRNUbSSOpGtGYjPFlrMIxlGlGMJ45&index=2) Their a lot further along, integrate with many Azure - abilities, and can do many things that Google/Firebase Functions can't.

## Resources

### Lists
- https://github.com/anaibol/awesome-serverless
- https://github.com/JustServerless/awesome-serverless - serverless project
...
### Suites
- https://zeit.co/now
- http://openwhisk.org - ibm bluemix
...
- https://blog.bredvid.no/using-azure-functions-for-slack-webhook-23d8cf207431 
...
### Other Services
- https://docs.microsoft.com/en-au/azure/event-hubs/event-hubs-what-is-event-hubs  
